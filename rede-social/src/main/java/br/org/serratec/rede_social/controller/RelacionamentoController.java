...
public class RelacionamentoController {
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "Usuário seguido com sucesso"),
	...
	public ResponseEntity<String> seguirUsuario(
			@Parameter(description = "ID do usuário que deseja seguir outro") @PathVariable Long usuarioId,
			@Parameter(description = "ID do usuário a ser seguido") @PathVariable Long seguindoId) {
	...
	public ResponseEntity<String> deixarDeSeguir(
			@Parameter(description = "ID do usuário que deseja deixar de seguir outro usuário") @PathVariable Long usuarioId,
			@Parameter(description = "ID do usuário que não será mais seguido") @PathVariable Long seguindoId) {
